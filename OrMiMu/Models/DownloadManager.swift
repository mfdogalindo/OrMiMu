...
class DownloadManager: ObservableObject {
    ...
    struct FailedDownloadItem: Identifiable {
        let id = UUID()
        let title: String
        let url: String
        let error: String
    ...
    @Published var failedDownloads: [FailedDownloadItem] = []
            ...
            do {
                ...
                for (index, video) in videos.enumerated() {
                    ...
                    do {
                        ...
                        failedCount += 1
                        await MainActor.run {
                            failedDownloads.append(FailedDownloadItem(title: videoTitle, url: videoUrl.absoluteString, error: error.localizedDescription))
